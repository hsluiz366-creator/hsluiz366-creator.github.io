document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log(
        "%c[SYSTEM ONLINE] // HuberOS Kernel v1.0 - Luiz Hubner Loaded Successfully.",
        "color: #00f0ff; background: #02040a; font-family: monospace; font-size: 13px; padding: 6px; border: 1px solid #00f0ff;"
    );
    ...
    const heroTitle = document.querySelector('.terminal-box h1') as HTMLElement;
    if (heroTitle) {
